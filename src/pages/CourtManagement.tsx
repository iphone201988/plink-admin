            ...
            <Table>
              <TableHeader className="bg-gray-50 dark:bg-gray-800">
                <TableRow>
                  ...
                  <TableHead className="text-xs font-medium text-textLight dark:text-gray-400 uppercase tracking-wider">Capacity</TableHead>
                  ...
                  <Card className="h-full">
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3 mb-4">
                        <div>
                          <p className="text-sm font-medium text-textDark dark:text-white">Type</p>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-textLight dark:text-gray-400">{court.capacity} players</p>
                        </div>
                        <div>
